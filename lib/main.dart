...
import 'package:egypt_gate/backend/check_connection.dart';
...
Future<void> main() async {
  ...
  // Getting the camera first and foremost
...
class MyApp extends StatelessWidget {
  ...
  const MyApp(this.camera, this.connected);
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: HomeScreen(camera, connected),
